                ...
                if(!$result){
                    ...
                    if($row > 0){
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td>$row[process]</td>
                            <td>$row[doctor]</td>
                            <td><a href='./edit_doctor_animal.php/?id=$row[id]' class='btn btn-primary  my-1 d-flex'>Edit</a><a href='./delete_doctor_animal.php/?id=$row[id]' class='btn btn-danger d-flex'>Delete</a></td>
                        </tr>";
                        }
                    }
