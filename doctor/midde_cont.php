<div class="midde_cont">
                     ...
                     <div class="row column1">
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">pending</p>
                                    <p class="head_couter">Treatment</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        <p>Copyright © 2024 Designed by Yaseen Hashmani. All rights reserved.<br><br>
                           Distributed By: <a href="../doctor/profile_doctor.php">Yaseen Hashmani</a>
                        </p>
                     </div>
                  </div>
               </div>